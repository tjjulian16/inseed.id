  ...
  <a href=""> <li style="margin-top: 10%;" class="list-group-item"><i class="fa fa-box-open"></i>Kelola Produk</li></a>
    ...
    <div class="col-md-9">
            ...
            <div class="card-header" style="background-color: white;">
             <h4 style="font-weight: bold;"> Kelola proyek investasi inseed.id</h4>
             <h6> Kelola semua proyek yang ada di inseed.id</h6>
            </div>
            <div class="card-body ">
              <div class="row">
                    ...
                    <thead>
                        <tr class="headerKeranjang">
                            ...
                            <th scope="col" class="text-left">Nama Proyek</th>
                             <th scope="col" class="text-left">Status Proyek</th>
